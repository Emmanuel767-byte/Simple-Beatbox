 ...
 */
triggerBeat = (event) => {
   const PRESSCODE = event.keyCode;

   if(PRESSCODE in beats){
       console.log("its working");
       let valid_keypress= beats[PRESSCODE];//GET the OBJECT(audio object) based on keycode(PRESSCODE)
       valid_keypress.beat.play()
       valid_keypress.button.select()
 ...
 */
document.addEventListener('keydown', triggerBeat);//YOU can parse in a function right awaay for the addeventlISTENER
